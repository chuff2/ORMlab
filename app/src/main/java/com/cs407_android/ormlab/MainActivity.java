...
public class MainActivity extends AppCompatActivity {
    ...
    private void initDatabase(){
        ...
        guestListFromDB = (List<Guest>) guestDao.queryBuilder().list();
        ...
        for ( Guest singleGuest: guestListFromDB)
            guestList.add(singleGuest.getFirstName() + " " + singleGuest.getLastName());
